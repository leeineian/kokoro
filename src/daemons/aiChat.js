...
const { DEFAULT_SYSTEM_PROMPT } = require('../commands/ai/.helper');
const ConsoleLogger = require('../utils/log/consoleLogger');

// AI Chat Configuration
const MODEL = "fast";
const PROCESSED_CACHE_TTL = 60000; // 60 seconds
const ATTACHMENT_LIMIT_BYTES = 50000; // ~50KB
const MAX_ATTACHMENT_TEXT_SIZE = 20000; // 20K characters
const MAX_HISTORY_FETCH = 50;
const LLM7_ENDPOINT = process.env.LLM7_ENDPOINT || "https://api.llm7.io/v1/chat/completions";

// Configuration
const TIMEZONE = process.env.BOT_TIMEZONE || 'UTC';
const statusRotator = require('./statusRotator');
const codebase = require('../utils/core/codebase');
...
async function handleMessage(message, client) {
    ...
    try {
        ...
        const customSystemPrompt = db.ai.getPrompt(message.author.id) || DEFAULT_SYSTEM_PROMPT;
