...
const (
	...
	EnvAIPrompt     = "AIPrompt"
	EnvAIModel      = "GEMINI_MODEL"
	EnvPuterToken   = "PUTER_TOKEN"
...
func LoadConfig() (*Config, error) {
	...
	cfg.AIPrompt = os.Getenv(EnvAIPrompt)
	cfg.AIModel = os.Getenv(EnvAIModel)
	cfg.PuterToken = os.Getenv(EnvPuterToken)
	cfg.ExaApiKey = os.Getenv(EnvExaApiKey)
